...
folder = 'D:\dtu\data\hand_eye\1016\3';
califile = fullfile(folder,'GH014308\tmp','extrinsics.mat');
timeoffsetfile = fullfile(folder,'GH014308\tmp','time_offset.mat');
GYRO_RATE_GUESS = 200;
imugps = GPS_IMU_Stream(GYRO_RATE_GUESS);
imufile = fullfile(folder,'imugps_camera.mat');
...
% vision position
visionfile = fullfile(folder,'GH014308\imgs','position_rec.mat');
load(visionfile);
