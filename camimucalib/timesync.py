...
def sync_camera_gyro(image_sequence_or_flow, image_timestamps, \
        gyro_data, gyro_timestamps, levels=6, full_output=False, \
                do_plot=False):
    ...
    *refine_time_offset* if you need better accuracy.
    ...
    try:
        ...
        flow_org = tracking_new.frametoframe_track(image_sequence_or_flow)
